...
const SETTING_EXIT_BUTTON_ID = 'js-settings-screen-exit-button';
const SETTING_SCREEN_ID = 'js-settings-screen';
...
class Settings extends Common {
    constructor() {
        super(SETTING_SCREEN_ID);
        this.bindToElements();
    }
    bindToElements() {
        const exitSettingsElement = this.bindToElement(SETTING_EXIT_BUTTON_ID);
